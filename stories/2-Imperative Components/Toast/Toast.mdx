...
- **Screen reader announcements**: Toast content is announced to screen readers while the visual container is hidden from assistive technologies to prevent duplicate announcements
